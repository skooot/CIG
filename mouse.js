...
function CIG(destinationImageId){   
    ...
    function initSelect(size){
        ...
        cBottomR.y = size;
        setPosition();
        document.getElementById('buttoncontainer').style.left = (img_x + 10) + 'px';
    }
 ...
 */
    ...
    div_c.id = 'buttoncontainer';
    var canvas = document.createElement('canvas');
    canvas.width = 10;
    canvas.height = 10;
    canvas.id = 'thecanvas';
    div_c.appendChild(canvas);
    var input = document.createElement('input');
    input.type = 'button';
    input.value = 'Save PNG';
    input.id = 'savepngbtn';
    div_c.appendChild(input);
    var h3 = document.createElement('h3');
    h3.text = 'Icon style';
    div_c.appendChild(h3);
    var button1 = document.createElement('button');
    div_c.appendChild(button1);
    var button2 = document.createElement('button');
    div_c.appendChild(button2);
    var button3 = document.createElement('button');
    div_c.appendChild(button3);
    var button4 = document.createElement('button');
    div_c.appendChild(button4);
    var button5 = document.createElement('button');
    div_c.appendChild(button5);
    var button6 = document.createElement('button');
    div_c.appendChild(button6);
    var button7 = document.createElement('button');
    div_c.appendChild(button7);
    mainObject.appendChild(div_c);
...
/*
    var imagesy = document.getElementsByTagName('img');
...
*/    
    ...
    for(var i = 0; i < patterns.length; i++){
        patterns[i].style.backgroundImage="url(p"+i+".png)";
    }
